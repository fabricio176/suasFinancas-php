...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Chama o método para inserir um novo valor mínimo para transações
    $inserido = $despesaModel->inserirOuAtualizarValorMinimo($userID, $valorMinimo);
    ...
    if ($inserido) {
        ...
        echo "<script>
                alert('Valor Mínimo definido com sucesso.');
                window.location.href = '../../usuario/dashboard.php';
              </script>";
        exit;
    } else {
        $erro = "Erro ao registrar Valor. Por favor, tente novamente mais tarde.";
